...
$router->group(['prefix'=>'api'], function() use ($router){
	...
	$router->get('app/log/{id}'					, "App\LogController@read");

	$router->get('app/logsystem/test'			, "App\LogSystemController@test");
	$router->get('app/logsystem/read'			, "App\LogSystemController@read");
	$router->delete('app/logsystem/{id}'		, "App\LogSystemController@delete");
