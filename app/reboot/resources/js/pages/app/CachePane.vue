<template>
	<el-row type="flex" justify="space-between">
		<el-col :span="12">
			<el-button-group>
				<el-button v-if="info.selections.length>0" @click="confirmDelete" type="danger" size="small" plain>
					{{ $t('button.delete') }}
				</el-button>
			</el-button-group>
		</el-col>
		<el-col :span="12" style="text-align:right">
			<el-button-group>
				<el-button type="success" size="small" :loading="info.loading" @click="getData" plain>
	...
	<el-table
		...
		<el-table-column prop="id" label="Key" width="150" sortable="custom"></el-table-column>
		<el-table-column prop="value" label="Data" sortable="custom">
